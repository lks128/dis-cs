...
namespace CA_LEC_11_1
{
    class СекундныеЧасы : МинутныеЧасы, IComparable
    {
        ...
        public class СравнениеПоЧасам : IComparer<СекундныеЧасы>
        {
            int IComparer<СекундныеЧасы>.Compare(СекундныеЧасы v_1, СекундныеЧасы v_2)
            {
                return v_1.Час.CompareTo(v_2.Час);
            }
        }

        public class СравнениеПоМинутам : IComparer<СекундныеЧасы>
        {
            int IComparer<СекундныеЧасы>.Compare(СекундныеЧасы v_1, СекундныеЧасы v_2)
            {
                return v_1.Минута.CompareTo(v_2.Минута);
            }
        }

        public class СравнениеПоСекундам : IComparer<СекундныеЧасы>
        {
            int IComparer<СекундныеЧасы>.Compare(СекундныеЧасы v_1, СекундныеЧасы v_2)
            {
                return v_1.Секунда.CompareTo(v_2.Секунда);
            }
        }
    }
}
